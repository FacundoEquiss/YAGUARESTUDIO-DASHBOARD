...
export function CalculatorPage() {
  ...
  const handleSave = () => {
    ...
    saveQuote({
      ...
      placements: packedResult.placements.map((p) => ({
    ...
    toast({
      ...
      description: "Se guardo en tu historial local.",
    });
    ...
    <div className="px-4 py-6 pb-12 sm:px-6 sm:py-6">
      ...
      <div className="hidden md:grid grid-cols-2 gap-2">
        ...
        >
          ...
          <span className="text-white font-bold text-sm">Guardar Cotizacion</span>
        </button>
        <button
