...
import { ArrowRight, BookOpen, Clock3, Home, Scissors, Shirt, Sparkles } from "lucide-react";

type ComingSoonFeature = "blog" | "bg-remover" | "mockups";
...
const FEATURE_COPY: Record<ComingSoonFeature, {
  ...
  mockups: {
    title: "Generador de mockups en preparacion",
    description:
      "Estamos rehaciendo el generador de mockups desde cero para que sea fluido, simple y con resultados a la altura.",
    bullets: [
      "Plantillas de remeras, buzos y mas.",
      "Subi tu arte y descarga el mockup listo.",
      "Optimizado para enviar a clientes por WhatsApp.",
    ],
    icon: Shirt,
  },
};
